...
require_installed_brew "bat-extras"                  # Bash scripts that integrate bat with various command-line tools: https://github.com/eth-p/bat-extras
...
require_installed_brew "csvlens"                     # Command line csv viewer: https://github.com/YS-L/csvlens
require_installed_brew "qsv"                         # Blazing-fast Data-Wrangling toolkit: https://github.com/dathere/qsv
